...
class SimConnectSink;
}

class simconnect::toolbox::blocks::SimConnectSink : public blockfactory::core::Block {
 public:
  static const std::string ClassName;

  SimConnectSink() = default;

  ~SimConnectSink() override = default;
 ...
 private:
  ...
  simconnect::toolbox::connection::SimConnectDataInterface simConnectInterface;
};
