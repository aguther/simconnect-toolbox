...
class simconnect::toolbox::blocks::SimConnectEvent : public blockfactory::core::Block {
 public:
  static const std::string ClassName;

  SimConnectEvent() = default;

  ~SimConnectEvent() override = default;
 ...
 private:
  ...
  simconnect::toolbox::connection::SimConnectEventInterface simConnectInterface;
};
