...
unsigned SimConnectSinkAutopilotLaws::numberOfParameters() {
  return Block::numberOfParameters() + 2;
}

bool SimConnectSinkAutopilotLaws::parseParameters(
...
bool SimConnectSinkAutopilotLaws::configureSizeAndPorts(
    BlockInformation *blockInfo
) {
  ...
  if (!SimConnectSinkAutopilotLaws::parseParameters(blockInfo)) {
...
bool SimConnectSinkAutopilotLaws::initialize(
    BlockInformation *blockInfo
) {
...
bool SimConnectSinkAutopilotLaws::output(
  ...
  data.locPhiCommand = inputSignals[6]->get<double>(0);
  ...
  if (data.enableAutopilot != lastData.enableAutopilot
      ...
      || data.locPhiCommand != lastData.locPhiCommand) {
...
bool SimConnectSinkAutopilotLaws::terminate(
    const BlockInformation *blockInfo
) {
  // disconnect
